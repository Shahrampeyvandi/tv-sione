    ...
    <nav>
        <div class="menuSite">
            ...
            <ul class="menuList">
                ...
                <li class="menuItems">
                    <a href="{{route('Blog.Category','articles')}}">
                ...
                <li class="menuItems">
                    <a href="{{route('Blog.Category','videos')}}">
                        <i class="far fa-camcorder"></i>
                        ویدیوها
                    </a>
                </li>
                <li class="menuItems">
                    <a href="{{route('Blog.Category','naghd-va-barrasi')}}">
...
<div class="search-modal" >
    ...
    <form class="search-from f-w" action="#" autocomplete="off" onsubmit="searchInBlogs(event,'{{route('Blog.Ajax.Search')}}')"> 
            <input
