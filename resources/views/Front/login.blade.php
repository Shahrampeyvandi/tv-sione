            ...
            <section class="main_login_register"
                ...
                <form action="{{route('login')}}" method="post" id="loginForm" class="loginform">
                    ...
                    <div class="input-place">
                        ...
                        <input type="tex" id="mobile" name="mobile" autocomplete="off" dir="rtl" @if($phone)
                            value="{{$phone}}" @endif placeholder="+98**********">
                    </div>
                    <div class="input-place">
                        <label for="password">
                            رمز عبور
                        </label>
                        <input type="password" id="password" @if($password) value="{{$password}}" @endif name="password"
