...
<div class="container-fluid">
    ...
    <div class="card">
        ...
        <?php else: ?> action="<?php echo e(route('Panel.AddSection',$serie->id)); ?>" <?php endif; ?> enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <input type="hidden" name="type" value="<?php echo e($serie->type ?? ''); ?>">

          <input type="hidden" name="serie" value="<?php echo e($serie->id ?? ''); ?>">
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="hidden" name="season" value="<?php echo e($season->id ?? ''); ?>">
                                <select name="number" id="number" class="form-control"
                                    onchange="showSectionData(event,'<?php echo e($serie->id); ?>','<?php echo e($season->number); ?>')">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control datepicker" name="release" id="release"
                                    <?php if(isset($section)): ?>
                                    value="<?php echo e(\Carbon\Carbon::parse($section->publish_date)->format('d F Y')); ?>"
                                    <?php endif; ?> />
                            </div>
                        </div>
                        <div class="row">
                        ...
                        <table id="example1" class="table table-striped table-bordered w-100">
                            <thead>
                                <tr>
                                    ...
                                    <th> فصل </th>
                                <th style="max-width: 70px">نام <?php echo e($type == 'series' ? 'سریال' : 'مستند'); ?></th>
                                    <th></th>
                                </tr>
                            </thead>
                            <tbody>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.Panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\sione\resources\views/Panel/Series/section.blade.php ENDPATH**/ ?>