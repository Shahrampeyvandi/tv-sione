...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="upload-movie" method="post" <?php if(isset($post)): ?> action="<?php echo e(route('Panel.EditSerie',$post)); ?><?php echo e(isset($type) && $type == 'documentary' ? '?t=documentary' : ''); ?>" <?php else: ?>
                action="<?php echo e(route('Panel.AddSerie')); ?><?php echo e(isset($type) && $type == 'documentary' ? '?t=documentary' : ''); ?>" <?php endif; ?> enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 row add-code" style="display: none">
                                ...
                                <a href="#" onclick="getCode(event,'<?php echo e($type); ?>')" class="btn btn-primary my-2">جست و جو &nbsp;<i
                            ...
                            <div class="form-group col-md-12">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" name="comming_soon"
                                        id="comming_soon" value="1" <?php if(isset($post) && $post->comming_soon): ?>
                                    checked
                                    <?php endif; ?>
                                    >
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="text" class="form-control" name="name"
                                    onblur="checkName(event,'<?php echo e(route('Panel.checkNameAjax')); ?>')" id="original-title"
                        ...
                        <div class="row series-date">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control datepicker" name="first_release"
                                    id="first_release" <?php if(isset($post)): ?>
                                    value="<?php echo e(\Carbon\Carbon::parse($post->first_publish_date)->format('d F Y')); ?>"
                                    <?php endif; ?>>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control datepicker" name="last_release" id="last_release"
                                    <?php if(isset($post)): ?>
                                    value="<?php echo e(\Carbon\Carbon::parse($post->last_publish_date)->format('d F Y')); ?>"
                                    <?php endif; ?>>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="serie_status" id="serie_status"
                                    value="<?php echo e($post->post_status ?? ''); ?>">
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <img alt="" id="preview" width="100%" style="max-height: 400px" src="<?php if(isset($post)): ?>
                                             <?php echo e($post->show_poster('resize')); ?> 
                                                <?php else: ?>
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                <a class="btn btn-outline-primary" href="<?php echo e(route('Panel.SeriesList')); ?>">بازگشت &nbsp;<i
...
<script>
    ...
    function getCode(event,type = '') {
            ...
            data = { code:code,type:type,_token: "<?php echo e(csrf_token()); ?>" };
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.Panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tm\resources\views/Panel/Series/add.blade.php ENDPATH**/ ?>