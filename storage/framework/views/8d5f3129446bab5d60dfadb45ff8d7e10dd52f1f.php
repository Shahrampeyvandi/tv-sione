...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form id="upload-movie" method="post" <?php if(isset($post)): ?>
                action="<?php echo e(route('Panel.EditSerie',$post)); ?><?php echo e(isset($type) && $type == 'documentary' ? '?t=documentary' : ''); ?>"
                <?php else: ?>
                action="<?php echo e(route('Panel.AddSerie')); ?><?php echo e(isset($type) && $type == 'documentary' ? '?t=documentary' : ''); ?>"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8 row add-code" style="display: none">
                                ...
                                <div class="wrapper--btn col-md-6">
                                    <a href="#" onclick="getCode(event,'<?php echo e($type); ?>')" class="btn btn-primary my-2">جست و
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('Layout.Panel', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp1\htdocs\sione\resources\views/Panel/Series/add.blade.php ENDPATH**/ ?>