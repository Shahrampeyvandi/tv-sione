<div class="col-md-4 right-side">
    ...
    <div class="cast-wrapper mt-3">
        ...
        <div class="actors-list card pr-2" style="min-height:50px;max-height: 200px;overflow-y: scroll;">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php else: ?>
            <?php $__currentLoopData = \App\Actor::orderBy('name','asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" id="actor-<?php echo e($key+1); ?>" name="actors[]" value="<?php echo e($item->name); ?>"
                    class="custom-control-input" >
                <label class="custom-control-label" for="actor-<?php echo e($key+1); ?>">
    ...
    <div class="cast-wrapper mt-3">
        ...
        <div class="directors-list card pr-2" style="min-height:50px;max-height: 200px;overflow-y: scroll;">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php else: ?>
            <?php $__currentLoopData = \App\Director::orderBy('name','asc')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="custom-control custom-checkbox custom-control-inline">
                <input type="checkbox" id="actor-<?php echo e($key+1); ?>" name="actors[]" value="<?php echo e($item->name); ?>"
                    class="custom-control-input" >
                <label class="custom-control-label" for="actor-<?php echo e($key+1); ?>">
...
<input type="hidden" name="top250" id="top250"><?php /**PATH C:\xampp\htdocs\tm\resources\views/Includes/Panel/sidemovie.blade.php ENDPATH**/ ?>